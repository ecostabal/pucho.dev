        ...
        <div className="flex items-center space-x-4 rotate-90">
            {socialMedia.map((social, index) => (
                <React.Fragment key={social.name}>
                    <a href={social.url} className="flex items-center font-exo2 uppercase tracking-widest text-white text-xs hover:text-yellow-600 transition-colors duration-300">
